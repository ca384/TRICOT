...
for(trt in 1:length(trait_list)){
  trt1 = trait_list[[trt]] # subsetting of the trait list
...
# name for each model
labels = c("Overall", "Germination","Pgwt","SuitSE")
...
# name for each model
labels =  c("Overall","Germination", "Pgwt", "Canopy", "Branching", "Disease", "Early_bulking")
...
# name for each model
labels =  c("Overall_impression","Germination", "Pgwt", "Canopy", "Branching", "Disease", "Early_bulking")
...
# name for each model
labels =  c("Overall_impression", "Pgwt", "Canopy", "Branching", "Suitability")
